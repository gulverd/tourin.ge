  ...
  <div class="container-fluid">
    ...
    <!-- Brand and toggle get grouped for better mobile display -->
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index_ru.php"><Span id="logo_font">TOUR</span><span id="logo_i">I</Span><Span id="logo_font">N.GE</Span> </a>
      </div>

      <!-- Collect the nav links, forms, and other content for toggling -->
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav" id="men_rus_but">
          <li><a href="index_ru.php">Главная</a></li>
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Туры <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li><a href="tours_ru.php">Туры в Грузию</a></li>
              <li><a href="personal_ru.php">Личный тур</a></li>
            </ul>
          <li><a href="events_ru.php" id="events_a">События</a></li>
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><img src="img/rus.jpeg" id="flag_img"> <span class="caret"></span></a>
