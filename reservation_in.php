   ...
   <form action="" method="post">
      <div class="col-md-12" id="middle_reservation_cont_in">
            <div class="form-group">
               ...
               <?php 
                  ...
                  while($row2 = mysqli_fetch_array($run2)){
                     $id            = $row2['id'];
                     $city_name_geo = $row2['city_name_geo'];
                     echo '<option value="'.$id.'">' .$city_name_geo.'</option>';
                  }
               ?>
               </select>
            </div>
            ...
            <select class="form-control" name="tour_genre">
               <?php 
                  ...
                  while($row = mysqli_fetch_array($run)){
                     $id             = $row['id'];
                     $genre_name_geo = $row['genre_name_geo'];
                     echo '<option value="'.$id.'">' .$genre_name_geo.'</option>';
                  }
               ?>
            </select>
         </div>
         ...
         <div class="col-md-6" id="res_bottom_right">
            <div class="form-group">
               <label>ბავშვები 10 წლამდე</label>
         ...
         <div class="col-md-6" id="res_bottom_left">
            <div class="form-group">
               <label>სახელი</label>
               <input type="text" name="fname" class="form-control" placeholder="მაგ: გიორგი" autocomplete="off">
            </div>
         </div>
         <div class="col-md-6" id="res_bottom_right">
            <div class="form-group">
               <label>გვარი</label>
               <input type="text" name="lname" class="form-control" placeholder="მაგ: მაისურაძე" autocomplete="off">
            </div>
         </div>
         <div class="col-md-6" id="res_bottom_left">
            <div class="form-group">
               <label>ტელეფონის ნომერი</label>
               <input type="text" name="tel" class="form-control" placeholder="მაგ: 578-555-555" autocomplete="off">
            </div>
         </div>
         <div class="col-md-6" id="res_bottom_right">
            <div class="form-group">
               <label>ელ-ფოსტა</label>
               <input type="email" name="email" class="form-control" placeholder="მაგ: john-jolly@example.com" autocomplete="off">
            </div>
         </div>
         <div class="form-group">
            <a href="res"><input type="submit" name="submit" value="დაჯავშნა" class="btn btn-success" id="main_submit">
         </div>
      </div>
   </form>
<?php
      ...
      if(isset($_POST['submit'])){
         ...
         if(!empty($tel) or !empty($email) or !empty($fname) or !empty($lname)){
          ...
          $message = '
            ...
            header('location: booking_personal.php?city='.$city.'&tour_genre='.$tour_genre.'&dateFrom='.$dateFrom.'&dateTo='.$dateTo.'&adultNumber='.$adultNumber.'&childNumber='.$childNumber.'&datee='.$datee);
