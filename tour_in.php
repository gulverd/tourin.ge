  ...
  //echo $url;
   ...
   $run11   = mysqli_query($conn,$query11);
            ...
            while($row11 = mysqli_fetch_array($run11)){
              $tour_name_geo11    = $row11['tour_name_geo'];
              $tour_desc_geo11    = $row11['tour_desc_geo'];
...
<html lang="ge">
  <head>
    ...
    <meta property="og:title" content="<?php echo $tour_name_geo11;?>" />
    <meta property="og:description" content="<?php echo $tour_desc_geo11;?>" />
              ...
              if($region1 != ''){
                  ...
                  while($rowCity1 = mysqli_fetch_array($cityRun1)){
                    $reg1 = '<div class="col-md-12" id="tour_right_pannels">
                              <h4><span id="tourin_price"><i class="fa fa-map-marker" aria-hidden="true"></i> '.$rowCity1['city_name_geo'].'</span></h4>
                            </div>';
                    $reg1Desc = $rowCity1['desc_geo'];
                    $reg1Wiki = $rowCity1['wiki_geo'];
              ...
              if($region2 != ''){
                ...
                while($rowCity2 = mysqli_fetch_array($cityRun2)){
                  $reg2 = '<div class="col-md-12" id="tour_right_pannels">
                            <h4><span id="tourin_price"><i class="fa fa-map-marker" aria-hidden="true"></i> '.$rowCity2['city_name_geo'].'</span></h4>
                          </div>';
                  $reg2Desc  = $rowCity2['desc_geo'];
                  $reg2Wiki  = $rowCity2['wiki_geo'];
              ...
              if($region3 != ''){
                ...
                while($rowCity3 = mysqli_fetch_array($cityRun3)){
                  $reg3 = '<div class="col-md-12" id="tour_right_pannels">
                            <h4><span id="tourin_price"><i class="fa fa-map-marker" aria-hidden="true"></i> '.$rowCity3['city_name_geo'].'</span></h4>
                          </div>';
                  $reg3Desc   = $rowCity3['desc_geo'];
                  $reg3Wiki   = $rowCity3['wiki_geo'];
              ...
              if($region4 != ''){
                ...
                while($rowCity4 = mysqli_fetch_array($cityRun4)){
                  $reg4 = '<div class="col-md-12" id="tour_right_pannels">
                              <h4><span id="tourin_price"><i class="fa fa-map-marker" aria-hidden="true"></i> '.$rowCity4['city_name_geo'].'</span></h4>
                           </div>';
                  $reg4Desc   = $rowCity4['desc_geo'];
                  $reg4Wiki   = $rowCity4['wiki_geo'];
                    ...
                    <div class="col-md-12" id="inside_tour_left_wrapper">
                      ...
                      <div class="col-md-12" id="tour_in_description">
                        <ul class="nav nav-tabs" role="tablist" id="tabi">
                          <li role="presentation" class="active"><a href="#desc" aria-controls="desc" role="tab" data-toggle="tab">ტურის დეტალები</a></li>   
                          <li role="presentation"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">მარშუტი</a></li>                       
                          <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">რეგიონის შესახებ</a></li>
                  ...
                  <div class="col-md-4">
                    <div class="col-md-12" id="inside_tour_right_wrapper">
                      ...
                      <div class="col-md-6" id="tour_right_pannels">
                        <h4><i class="fa fa-calendar-o" aria-hidden="true"></i>  '.$tour_length.' დღე </h4>
                      </div>
                      <div class="col-md-12" id="tour_right_pannels">
                        <h4><span id="tourin_price"><i class="fa fa-money" aria-hidden="true"></i> <span id="tour_in_price_span">'.$tour_price .' - დან '.'</span></span></h4>
                      </div>
                      <div class="col-md-12" id="tour_right_button_wrapper">
                        <a href="booking_tour.php?id='.$tour_id.'"><button type="button" class="btn btn-success" id="tour_in_book_button">დაჯავშნა</button></a>
                      </div>
