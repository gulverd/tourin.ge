<div class="container" id="middle_container">	
   	<div class="col-md-12" id="middle_content_header">
   		<h2>ტურები საქართველოში</h2> <h4><a href="tours.php">(ვრცლად)</a></h4>
   	</div>
   	<div class="col-md-12" id="middle_content_cont">
         <?php
                    ...
                    while($row = mysqli_fetch_array($run)){
                        ...
                        $tour_location_geo  = $regi1 . ' ' . $regi2 . ' ' . $regi3 . ' ' . $regi4;

                        echo  
                           '
                           <a href="tour_in.php?'.$id.'">
