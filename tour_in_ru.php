<?php 
  ...
  //echo $url;
   $query11 = "SELECT * FROM tours WHERE id = '$tour_id'";
   $run11   = mysqli_query($conn,$query11);

            while($row11 = mysqli_fetch_array($run11)){
              $tour_name_rus11    = $row11['tour_name_rus'];
              $tour_desc_rus11    = $row11['tour_desc_rus'];
              $tour_length11      = $row11['tour_length'];
              $tour_pic111        = $row11['tour_pic1'];
            }
...
<html lang="ge">
  <head>
    ...
    <meta property="og:title" content="<?php echo $tour_name_rus11;?>" />
    <meta property="og:description" content="<?php echo $tour_desc_rus11;?>" />
    <meta property="og:image" content="http://tourin.ge/images/tours/<?php echo $tour_pic111;?>" />
    <meta property="og:image:type" content="image/jpeg" />
    <meta property="og:image:width" content="1200" />
    <meta property="og:image:height" content="630" />
    <meta property="og:site_name" content="Tourin.ge" />
  </head>
  <body>
  <script>
    window.fbAsyncInit = function() {
      FB.init({
        appId      : '483602361844591',
        xfbml      : true,
        version    : 'v2.6'
      });
    };
      ...
      <div class="container">
        <?php
            ...
            while($row = mysqli_fetch_array($run)){
             ...
             // $tour_location_rus  = $row['tour_location_rus'];
              ...
              if($region1 != ''){
                  ...
                  while($rowCity1 = mysqli_fetch_array($cityRun1)){
                    $reg1 = '<div class="col-md-12" id="tour_right_pannels">
                              <h4><span id="tourin_price"><i class="fa fa-map-marker" aria-hidden="true"></i> '.$rowCity1['city_name_rus'].'</span></h4>
                            </div>';
                    $reg1Desc = $rowCity1['desc_rus'];
                    $reg1Wiki = $rowCity1['wiki_rus'];
              ...
              if($region2 != ''){
                ...
                while($rowCity2 = mysqli_fetch_array($cityRun2)){
                  $reg2 = '<div class="col-md-12" id="tour_right_pannels">
                            <h4><span id="tourin_price"><i class="fa fa-map-marker" aria-hidden="true"></i> '.$rowCity2['city_name_rus'].'</span></h4>
                          </div>';
                  $reg2Desc = $rowCity2['desc_rus'];
                  $reg2Wiki = $rowCity2['wiki_rus'];
              ...
              if($region3 != ''){
                ...
                while($rowCity3 = mysqli_fetch_array($cityRun3)){
                  $reg3 = '<div class="col-md-12" id="tour_right_pannels">
                            <h4><span id="tourin_price"><i class="fa fa-map-marker" aria-hidden="true"></i> '.$rowCity3['city_name_rus'].'</span></h4>
                          </div>';
                  $reg3Desc = $rowCity3['desc_rus'];
                  $reg3Wiki = $rowCity3['wiki_rus'];
              ...
              if($region4 != ''){
                ...
                while($rowCity4 = mysqli_fetch_array($cityRun4)){
                  $reg4 = '<div class="col-md-12" id="tour_right_pannels">
                              <h4><span id="tourin_price"><i class="fa fa-map-marker" aria-hidden="true"></i> '.$rowCity4['city_name_rus'].'</span></h4>
                           </div>';
                  $reg4Desc = $rowCity4['desc_rus'];
                  $reg4Wiki = $rowCity4['wiki_rus'];
                  $regImg4  = $rowCity4['img1'];
                    ...
                    <div class="col-md-12" id="inside_tour_left_wrapper">
                      ...
                      <div class="col-md-12" id="tour_in_description">
                        <ul class="nav nav-tabs" role="tablist" id="tabi">
                          <li role="presentation" class="active"><a href="#desc" aria-controls="desc" role="tab" data-toggle="tab">Подробности тура</a></li> 
                          <li role="presentation"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Маршруты</a></li>
                          <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">О регионе</a></li>
                          <li role="presentation"><a href="#comments" aria-controls="comments" role="tab" data-toggle="tab">Коментары</a></li>
                        </ul>

                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="desc">
                              <div class="col-md-12" id="route_tour_in">
                                '.nl2br($about_tour_rus).'
                              </div>
                            </div>                
                  ...
                  <div class="col-md-4">
                    <div class="col-md-12" id="inside_tour_right_wrapper">
                      ...
                      <div class="col-md-6" id="tour_right_pannels">
                        <h4><i class="fa fa-calendar-o" aria-hidden="true"></i>  Число Дней: '.$tour_length.'</h4>
                      </div>
                      <div class="col-md-12" id="tour_right_pannels">
                        <h4><span id="tourin_price"><i class="fa fa-money" aria-hidden="true"></i> <span id="tour_in_price_span"> От - '.$tour_price.'</span></span></h4>
                      </div>
                      <div class="col-md-12" id="tour_right_button_wrapper">
                        <a href="booking_tour_ru.php?id='.$tour_id.'"><button type="button" class="btn btn-success" id="tour_in_book_button">Бронирование</button></a>
                      </div>
