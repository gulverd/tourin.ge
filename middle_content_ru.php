<div class="container" id="middle_container">	
   	<div class="col-md-12" id="middle_content_header">
   		<h2>Туры в Грузию</h2> <h4><a href="tours_ru.php">(Далее)</a></h4>
   	</div>
         ...
         <?php
                    ...
                    while($row = mysqli_fetch_array($run)){
                     ...
                     //   $tour_location_rus  = $row['tour_location_rus'];
                        ...
                        $tour_location_rus  = $regi1 . ' ' . $regi2 . ' ' . $regi3 . ' ' . $regi4;

                        echo  
                           '
                           <a href="tour_in_ru.php?'.$id.'">
