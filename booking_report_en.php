    ...
    <div class="col-md-12" id="middle_wrapper">
      <div class="container">
        <div class="col-md-12" id="booking_tour_main_wrapper">
          ...
          <div class="col-md-12">
            <?php
                $query = "SELECT a.fname, a.lname,a.p_id,a.email,a.tel,a.humans_count,a.datee, b.tour_name_eng ,b.tour_location_eng, b.tour_price, b.tour_valute, a.tour_date FROM `booking` a JOIN tours b ON a.tour_id = b.id  
                WHERE a.id = '$tour_id' ";
                ...
                while($row = mysqli_fetch_array($run)){
                  ...
                  echo '
                    ...
                    <div class="col-md-5" id="bookkng_date_wrapper">
                      Request Date: <span id="tour_in_price_span">'.$datee.'</span>
                    </div>
                    <div class="col-md-7" id="bookkng_date_wrapper">
                      Tour Price : <span id="tour_in_price_span">'.$tour_price.'</span>
                    </div>
                    <div class="col-md-12">
