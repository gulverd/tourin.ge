  ...
  <div class="container-fluid">
    ...
    <!-- Brand and toggle get grouped for better mobile display -->
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index_en.php"><Span id="logo_font">TOUR</span><span id="logo_i">I</Span><Span id="logo_font">N.GE</Span> </a>
      </div>
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu">
              <li><a href="tours_en.php">Tours in Georgia</a></li>
              <li><a href="personal_en.php">Personal Tour</a></li>
            </ul>
          <li><a href="events_en.php" id="events_a">Events</a></li>
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><li><img src="img/great.jpg" id="flag_img"><span class="caret"></span></a>
