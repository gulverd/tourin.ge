            ...
            <div class="col-md-9">
              <form action="" method="POST">
                <div class="col-md-6" id="contact_inputs_wrapper">
                  <label>სახელი</label>
                  <input type="text" name="fname" placeholder="მაგ: გიორგი" class="form-control" autocomplete="off">
                </div>
                <div class="col-md-6" id="contact_inputs_wrapper">
                  <label>გვარი</label>
                  <input type="text" name="lname" placeholder="მაგ: მაისურაძე" class="form-control"  autocomplete="off">
                </div>
                <div class="col-md-6" id="contact_inputs_wrapper">
                ...
                <div class="col-md-6" id="contact_inputs_wrapper">
                  ...
                  <input type="text" name="phone" placeholder="მაგ: 545 45 45 45" class="form-control"  autocomplete="off">
                </div>
