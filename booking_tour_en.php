        ...
        <div class="col-md-12" id="booking_tour_main_wrapper">
          <form method="POST" action="">
              ...
              <div class="col-md-12" id="booking_inputs_wrapper">
                <input type="submit" class="btn btn-success" id="tour_in_book_button" name="submit" value="Booking">
              </div>
          </form>
        </div>
      </div>
...
<?php
    ...
    if(isset($_POST['submit'])){
      ...
      if(empty($fname) OR empty($lname) or empty($tel) or empty($email) or empty($humans_count)){
        echo 'გთხოვთ შეავსოთ ყველა ველი!';
          ...
          while($row2 = mysqli_fetch_array($run2)){
            $id                 = $row2['id'];
            $tour_name_eng      = $row2['tour_name_eng'];
            $tour_desc_eng      = $row2['tour_desc_eng'];
            $tour_length        = $row2['tour_length'];
            $tour_location_eng  = $row2['tour_location_eng'];
          ...
          $message = '
            ...
            <body>
                ...
                <table cellspacing="0" style="border: 1px solid #CCCCCC">
                    <tr>
                        <th width: 350px; heigth: 35px; font-color:#000000;>ტურის სახელი:</th><td width: 350px; heigth: 35px; font-color:#000000;>'. $tour_name_eng.'</td>
                    </tr>
                    <tr style="background-color: #e0e0e0;">
                        <th width: 350px; heigth: 35px; font-color:#000000;>ტურის ადგილმდებარეობა:</th><td width: 350px; heigth: 35px; font-color:#000000;>'. $tour_location_eng.'</td>
                    </tr>
                    <tr>
      ...
      // Instantiate Class  
          ...
          header('location: booking_report_en.php?id='.$booking_id);
