            ...
            <div class="col-md-9">
              <form action="" method="POST">
                <div class="col-md-6" id="contact_inputs_wrapper">
                  <label>Имя</label>
                  <input type="text" name="fname" placeholder="Наталья" class="form-control" autocomplete="off">
                </div>
                <div class="col-md-6" id="contact_inputs_wrapper">
                  <label>Фамилия</label>
                  <input type="text" name="lname" placeholder="Antonova" class="form-control"  autocomplete="off">
                </div>
                <div class="col-md-6" id="contact_inputs_wrapper">
                  <label>Эл. адрес</label>
                  <input type="text" name="mail" placeholder="someone@example.com" class="form-control"  autocomplete="off">
                </div>
                <div class="col-md-6" id="contact_inputs_wrapper">
